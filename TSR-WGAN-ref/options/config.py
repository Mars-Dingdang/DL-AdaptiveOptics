...
def train_options():
    ...
    parser.add_argument('--name', default='experiment_name', type=str, help='name of the experiment which corresponds '
                                                                            'to the store path')
    parser.add_argument('--checkpoint_dir', default='../data/checkpoints', type=str, help='path to the saved model')
    ...
    parser.add_argument('--lr_scheduler', default='RP', type=str,
                        help='method to adjust the learning rate: RP for ReduceLROnPlateau and Step for StepLR')
    parser.add_argument('--lr_decay', default=0.1, type=float, help='Multiplicative factor of learning rate decay')
    ...
    parser.add_argument('--crop_size', default=200, type=int, help='then crop to this size')
...
def test_options():
    ...
    parser.add_argument('--gpu_index', default='0', type=str, help='gpu ids:e.g. 0,1,2,...')
    parser.add_argument('--is_train', default=False, type=bool, help='true for traning and false for testing')
