"""Standalone diffusion training entrypoint for turbulence restoration."""
...
def train_one_epoch_diffusion(
    ...
    pbar = tqdm(loader, total=len(loader), disable=not use_tqdm, desc=f"Train Diff e{epoch}", leave=False, dynamic_ncols=True)
...
def main() -> None:
    args = parse_train_args("Train conditional diffusion model for atmospheric turbulence removal.")
